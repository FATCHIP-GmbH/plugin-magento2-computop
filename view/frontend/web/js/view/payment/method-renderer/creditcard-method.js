define(
    [
        ...
        'Fatchip_Computop/js/action/creditcardrequestdata',
    ],
    function ($, Component, additionalValidators, getCreditcardRequestData) {
        ...
        return Component.extend({
            defaults: {
                ...
                template_silent: 'Fatchip_Computop/payment/creditcard_silent',
                number: '',
                securityCode: '',
                expiryDate: '',
                expiryMonth: '',
            ...
            isSilentMode: function () {
                if (window.checkoutConfig.payment.computop.computop_creditcard.mode === 'silent') {
                    return true;
                }
                return false;
            },
            ...
            getCcAvailableTypes: function () {
                this.getCcMonths();
                return window.checkoutConfig.payment.computop.computop_creditcard.types;
            },
            ...
            continueToComputop: function () {
                if (this.validate() && additionalValidators.validate()) {
                    let redirectTarget = 'computop/onepage/redirect/';
                    if (window.checkoutConfig.payment.computop.computop_creditcard.mode === 'iframe') {
                        redirectTarget = 'computop/onepage/payment/';
                    }
                    if (this.isSilentMode() === true) {
